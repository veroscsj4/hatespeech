        ...
        return <div className="">
            <div className="background-path-secondary uk-margin-xlarge-bottom">
                <div className="uk-container">
                    <div data-uk-grid className="uk-grid-small header-center-container uk-flex uk-flex-center uk-flex-middle uk-margin-large-top">
                        ...
                        <div className="hero-image uk-width-expand@m uk-width-3-5@s uk-visible@s"><img src={"/assets/img/" + this.props.image}  alt={this.props.description} width={this.props.imageWidth}/></div>
                    </div>
                </div>
            </div>
        </div>
