# SystemsDevelopmentWS23-SocialMediaContentModeration
...
```
cd existing_repo
git remote add origin https://gitlab.rz.htw-berlin.de/peikert/systemsdevelopmentws23-socialmediacontentmoderation.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.rz.htw-berlin.de/peikert/systemsdevelopmentws23-socialmediacontentmoderation/-/settings/integrations)
...
## Name
Hassmelder - Ein Klick gegen Hass.
## Description
