...
const ReportFormComponent = () => {
  ...
  const isValidLink = (link) => {
    const linkRegex =
      /^(https?:\/\/)?(www\.)?(facebook\.com|reddit\.com|instagram\.com|x\.com|twitter\.com)\/.*/i;
              ...
              <div>
                <div>
                  ...
                  <p>
                    ...
                    contains hate speech, let us investigate it for you. Just
                    copy and paste the content here, and if available, attach
                    the relevant link.{" "}
                  </p>
                  <p>
                    ...
                    <div className="uk-margin">
                      ...
                      {!isLinkValid && (
                        <p className="uk-text-danger">
                          Please enter a valid Link. (Facebook, Instagram,
                          Reddit or X)
                        </p>
                      )}
                    </div>
