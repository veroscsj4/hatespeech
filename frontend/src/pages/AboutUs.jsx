            ...
            <div className="uk-container">
                <div class="uk-child-width-1-2@m uk-child-width-1-1 uk-margin-large-bottom " data-uk-grid>
                    <div>
                        ...
                        <p>
                        Welcome to our platform! We are a community dedicated to combating hate speech. 
                        Our goal is to create a digital space characterized by respect, tolerance, and diversity. 
                        With advanced AI technology and a strong sense of community, we actively work towards reporting and preventing harmful content. 
                        Your support enables us to swiftly respond to potential hate speech, fostering a safe environment for all. 
                        </p>
                        ...
                        <p>
                        Join us in this solemn mission, as we strive to create an online community where the principles of dignity and understanding are upheld, and where the collective resolve against hate speech is unwavering. 
                        Together, we can shape a digital realm where every individual is afforded the respect and security they deserve.                        </p>
                    </div>
                    <div className="">
                ...
                <div className="uk-margin-xlarge-bottom" data-uk-grid>
                    ...
                    <div class="uk-width-2-3@m uk-width-1-1">
                        <div data-uk-grid className="uk-child-width-1-2@m uk-child-width-1-1" data-uk-height-match="target: a > div > .uk-card">
                            ...
                            <CardsImageSmall  name="City of Berlin" url="https://www.berlin.de/deeptech/standort/kompetenzfeld-it-security/" image="berlin.png"/>
                        </div>
                    </div>
